(function() {
  var AttributeUI, ContentTools, CropMarksUI, StyleUI, _EditorApp, exports,
  ...
  ContentTools = {
    ...
    getEmbedVideoURL: function(url) {
      var domains, id, j, k, kv, len, m, netloc, paramStr, params, paramsStr, parser, path, ref, v;
      domains = {
  ...
  ContentTools.InspectorUI = (function(superClass) {
    ...
    InspectorUI.prototype.updateCounter = function() {
      var column, completeText, element, j, len, line, lines, ref, region, sub, word_count;
      if (!this.isMounted()) {
        return;
      }
      completeText = '';
      ref = ContentTools.EditorApp.get().orderedRegions();
      for (j = 0, len = ref.length; j < len; j++) {
        region = ref[j];
        if (!region) {
          continue;
  ...
  ContentTools.TagUI = (function(superClass) {
    ...
    TagUI.prototype._onMouseDown = function(ev) {
      ...
      dialog.addEventListener('save', (function(_this) {
        return function(ev) {
          var applied, attributes, className, classNames, cssClass, detail, element, innerHTML, j, l, len, len1, name, ref, ref1, styles, value;
          detail = ev.detail();
  ...
  ContentTools.ToolboxUI = (function(superClass) {
    ...
    ToolboxUI.prototype.tools = function(tools) {
      var domToolGroup, i, j, len, ref, ref1, results, tool, toolGroup, toolName, toolUI;
      if (tools === void 0) {
        return this._tools;
      }
      this._tools = tools;
      ...
      for (i = j = 0, len = ref1.length; j < len; i = ++j) {
        ...
        results.push((function() {
          ...
          for (l = 0, len1 = toolGroup.length; l < len1; l++) {
            ...
            results1.push(this._toolUIs[toolName].addEventListener('applied', (function(_this) {
              return function() {
  ...
  ContentTools.PropertiesDialog = (function(superClass) {
    ...
    PropertiesDialog.prototype.mount = function() {
      ...
      ref = ContentTools.StylePalette.styles(this.element);
      for (j = 0, len = ref.length; j < len; j++) {
        style = ref[j];
  ...
  _EditorApp = (function(superClass) {
    ...
    _EditorApp.prototype.paste = function(element, clipboardData) {
      var character, content, cursor, encodeHTML, i, insertAt, insertIn, insertNode, item, itemText, j, lastItem, len, line, lineLength, lines, replaced, selection, spawn, tags, tail, tip, type;
    ...
    _EditorApp.prototype.revertToSnapshot = function(snapshot, restoreEditable) {
      var child, j, len, name, ref, ref1, region;
    ...
    _EditorApp.prototype.save = function(passive) {
      var child, html, j, len, modifiedRegions, name, ref, ref1, region, root;
    ...
    _EditorApp.prototype._addDOMEventListeners = function() {
      this._handleHighlightOn = (function(_this) {
        return function(ev) {
          var ref;
          if ((ref = ev.keyCode) === 17 || ref === 224 || ref === 91 || ref === 93) {
    ...
    _EditorApp.prototype._preventEmptyRegions = function() {
      var child, hasEditableChildren, j, lastModified, len, name, placeholder, ref, ref1, region, results;
      ...
      for (name in ref) {
        ...
        results.push(region._modified = lastModified);
      }
      return results;
    };
    ...
    _EditorApp.prototype._initRegions = function() {
      var domRegion, found, i, index, j, len, name, ref, ref1, region, results;
      found = {};
      this._orderedRegions = [];
      ref = this._domRegions;
      for (i = j = 0, len = ref.length; j < len; i = ++j) {
      ...
      for (name in ref1) {
        ...
        if (index > -1) {
          results.push(this._orderedRegions.splice(index, 1));
        } else {
          results.push(void 0);
        }
      }
  ...
  ContentTools.Tools.Link = (function(superClass) {
    ...
    Link.apply = function(element, selection, callback) {
      var allowScrolling, app, applied, characters, dialog, domElement, ends, from, measureSpan, modal, rect, ref, ref1, scrollX, scrollY, selectTag, starts, to, transparent;
      applied = false;
      if (element.type() === 'Image') {
      ...
      ref1 = ContentTools.getScrollPosition(), scrollX = ref1[0], scrollY = ref1[1];
      dialog.position([rect.left + (rect.width / 2) + scrollX, rect.top + (rect.height / 2) + scrollY]);
      dialog.addEventListener('save', function(ev) {
        var a, alignmentClassNames, className, detail, j, l, len, len1, linkClasses;
        detail = ev.detail();
        applied = true;
        if (element.type() === 'Image') {
          ...
          if (detail.href) {
            ...
            for (l = 0, len1 = alignmentClassNames.length; l < len1; l++) {
              className = alignmentClassNames[l];
  ...
  ContentTools.Tools.AlignLeft = (function(superClass) {
    ...
    AlignLeft.apply = function(element, selection, callback) {
      var alignmentClassNames, className, j, len, ref;
      if ((ref = element.type()) === 'ListItemText' || ref === 'TableCellText') {
        element = element.parent();
      }
  ...
  ContentTools.Tools.Table = (function(superClass) {
    ...
    Table.apply = function(element, selection, callback) {
      ...
      dialog.addEventListener('save', (function(_this) {
        return function(ev) {
          var index, keepFocus, node, ref, tableCfg;
          tableCfg = ev.detail();
          keepFocus = true;
          if (table) {
  ...
  ContentTools.Tools.Image = (function(superClass) {
    ...
    Image.apply = function(element, selection, callback) {
      ...
      dialog.addEventListener('save', (function(_this) {
        return function(ev) {
          var detail, image, imageAttrs, imageSize, imageURL, index, node, ref;
          detail = ev.detail();
